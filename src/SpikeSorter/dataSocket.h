...
public:
	...
	virtual t_ull	fetchNidqLatestAndReadBits(OSSSpecificParams osParams, t_ull lStartCt, bool &prevHigh, int &detectedSyllID, std::vector<t_ull> &edgeTimes, int m_nMaxSize = 240, int m_nMinSize = 40) = 0;
...
public:
	...
	t_ull	fetchNidqLatestAndReadBits(OSSSpecificParams osParams, t_ull lStartCt, bool &prevHigh, int &detectedSyllID, std::vector<t_ull> &edgeTimes, int m_nMaxSize = 240, int m_nMinSize = 40);
